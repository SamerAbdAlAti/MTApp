                  ...
                  SizedBox(
                    ...
                    child: PageView.builder(
                      ...
                      onPageChanged: (index) async {
                        cubit.onBoardingItemCurrentIndexMethod(currentIndex: index);
                      },
...
Widget buildSliderForOnBoarding(index) => BlocBuilder<OnBoardingsCubit, OnBoardingsState>(
      builder: (context, state) {
        return Padding(
          padding: EdgeInsets.all(Scaling.S(10)),
          child: SvgPicture.asset(
            state.onBoardingItemCurrentIndex == index ? onBoardingWhit : onBoardingNotWhit,
          ),
        );
      },
    );
