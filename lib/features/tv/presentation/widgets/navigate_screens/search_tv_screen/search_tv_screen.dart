  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<TvBloc, TvState>(
      builder: (context, state) {
        TvBloc tvBloc = TvBloc.get(context);
              ...
              children: [
                Padding(
                  ...
                  child: SizedBox(
                    height: Scaling.S(60),
                    child: TextField(
                      controller: tvBloc.controller,

                      /// TODO: Search Request
                      onSubmitted: (value) async {
                        context.read<TvBloc>().add(SearchTvEvent(query: value));
                      },
                ...
                BlocBuilder<TvBloc, TvState>(
                  buildWhen: (c, p) => c.tvSearchState != p.tvSearchState,
                  builder: (context, state) {
                                ...
                                child: SingleChildScrollView(
                                  child: Column(
                                    children: List<Widget>.generate(
                                      state.tvSearch.length,
                                      (index) {
                                        Tv model = state.tvSearch[index];
                                        return InkWell(
                                          onTap: () {
