...
import 'package:movie/features/tv/presentation/widgets/navigate_screens/you_tube_player/tv_you_tube_player_bottom_sheet.dart';
...
class TvDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<TvBloc, TvState>(
      buildWhen: (c, p) => c.tvDetailsState != p.tvDetailsState,
                        ...
                        SafeArea(
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsets.all(Scaling.S(20))
                                    .copyWith(bottom: Scaling.S(10), top: 0.0),
                                child: Row(
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        showModalBottomSheet(
                                            ...
                                            builder: (context) {
                                              return const TvYouTubPlayerBottomSheet();
                                            });
                                      },
                                      child: Padding(
                                        padding: EdgeInsets.all(Scaling.S(20))
                              ...
                              Container(
                                ...
                                padding: EdgeInsets.only(
                                    right: Scaling.S(20), left: Scaling.S(20)),
                                ...
                                SingleChildScrollView(
                                  ...
                                  child: Row(
                                    children: List.generate(
                                        state.getTvDetails.productionCompanies
                                            .length, (index) {
                                      return Padding(
                                        padding: EdgeInsets.only(
                                            left: Scaling.S(20)),
